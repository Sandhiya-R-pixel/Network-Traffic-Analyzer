...
To identify potential security threats or network inefficiencies.

To optimize data transfer between IoT devices and servers.
...
Network Simulator or IoT Devices – To simulate smart city components.
...
Create a virtual or small-scale network (e.g., traffic cameras, sensors, control servers).

Capture Network Traffic

Use Wireshark to capture live packets from the network.

Analyze Data

Identify bandwidth usage, latency, packet loss, and protocol distribution.

Detect Anomalies

Monitor unusual activities (e.g., packet floods, unauthorized access).
...
Early detection of cyber threats or performance bottlenecks.

Improved sustainability through optimized network resource usage.
...
Enhances urban safety by ensuring uninterrupted operation of IoT-based public services.

Supports innovation and efficiency in smart governance and city management.

7. Conclusion

Using Wireshark as a network traffic analyzer can significantly contribute to building smarter, safer, and more sustainable cities. By ensuring robust communication among IoT systems, the project aligns with SDG 11—advancing toward sustainable urban development.
